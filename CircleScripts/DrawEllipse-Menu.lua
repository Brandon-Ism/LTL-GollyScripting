-- Allows user to draw an ellipse (live cells) given options of:
...
while true do
    local choice = g.getstring("Choose a method to create an ellipse (live cells):\n"..
