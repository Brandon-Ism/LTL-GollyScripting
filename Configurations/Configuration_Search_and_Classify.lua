...
file_all:write('Shape of Live Cells,Dimensions of Live Shape,Y Setback,Shape of Dead Cells,Dimensions of Dead Shape,' .. '"' .. g.getrule() .. '"', "\n")
file_survive:write('Shape of Live Cells,Dimensions of Live Shape,Y Setback,Shape of Dead Cells,Dimensions of Dead Shape,Period,dy,Population,Bound Box Wd,Bound Box Ht,Hash Value,' .. '"' .. g.getrule() .. '"', "\n")
file_not_survive:write('Shape of Live Cells,Dimensions of Live Shape,Y Setback,Shape of Dead Cells,Dimensions of Dead Shape,' .. '"' .. g.getrule() .. '"', "\n")
file_still:write('Shape of Live Cells,Dimensions of Live Shape,Y Setback,Shape of Dead Cells,Dimensions of Dead Shape,Period,dy,Hash Value,' .. '"' .. g.getrule() .. '"', "\n")
file_timeout:write('Shape of Live Cells,Dimensions of Live Shape,Y Setback,Shape of Dead Cells,Dimensions of Dead Shape,' .. '"' .. g.getrule() .. '"', "\n")
-----------------------------------------------------------------------------------------------
