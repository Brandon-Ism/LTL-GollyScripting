...
-- Function to draw filled rectangle between two corner points.
...
-- Function to draw the outline of a rectangle between two corner points.
...
while true do
    local choice = g.getstring("Choose a method to create a rectangle or rectangle outline:\n"..
                               "1) Draw filled rectangle with a live cell preview.\n"..
                               "2) Input dimensions/vertices for filled rectangle.\n"..
                               "3) Draw rectangle outline with a live cell preview.\n"..
